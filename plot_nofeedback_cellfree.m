function plot_nofeedback_cellfree

% This is to plot the data for negative feedback in cell free context

close all 
clear all

% load no_feedback_cellfree_resource_limited

% uncomment for plotting parameter distributions and transient response
